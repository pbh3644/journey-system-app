package com.cmrh.journey.system.common.org.n3r.idworker.utils;
...
public class HttpReq {
    ...
    private final static int TWO_HUNDRED = 200;
    ...
    private static String getCharset(String contentType) {
        ...
        String charset = null;
        for (String param : contentType.replace(BLANK, "").split(SEMICOLON)) {
