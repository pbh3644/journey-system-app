...
CREATE TABLE application(
	...
	s_add_time datetime not null COMMENT '增加时间',
	s_update_time datetime DEFAULT NULL  COMMENT '修改时间',
	s_delete_time datetime DEFAULT NULL  COMMENT '删除时间',
	s_add_user_id BIGINT(32) NOT NULL  COMMENT '增加用户ID',
	s_update_user_id BIGINT(32) DEFAULT NULL  COMMENT '修改用户ID',
	s_delete_user_id BIGINT(32) DEFAULT NULL  COMMENT '删除用户ID',
	s_delete_flag tinyint(1) DEFAULT 0 COMMENT '状态0:正常,1:删除',
	s_remark varchar(30) DEFAULT NULL COMMENT '备注'
)COMMENT='服务系统的注册中心' ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT into application(application_name_english,application_name_chinese,application_ip,s_add_time,s_add_user_id,s_remark)
...
INSERT into organization(id,application_id,organization_data_name,s_add_time,s_add_user_id,s_remark)
